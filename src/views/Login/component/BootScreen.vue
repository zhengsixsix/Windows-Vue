  ...
  #box {
    ...
    div {
      ...
      span {
        ...
        &:nth-child(2) {
          animation: i2 5.5s 0.2s infinite;
        }
        &:nth-child(3) {
          animation: i3 5.5s 0.2s infinite;
        }
        &:nth-child(4) {
          animation: i4 5.5s 0.2s infinite;
        }
        &:nth-child(5) {
          animation: i5 5.5s 0.2s infinite;
        }
        &:nth-child(6) {
          animation: i6 5.5s 0.2s infinite;
        }
      }
    }
  }
